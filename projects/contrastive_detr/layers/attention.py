"""
https://github.com/IDEA-Research/detrex/blob/main/detrex/layers/attention.py
"""
...
class ConditionalSelfAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs allow passing a more general data flow when combining
        ...
        assert (query_pos is not None and
                key_pos is not None), "query_pos and key_pos must be passed into ConditionalAttention Module"
...
class ConditionalCrossAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs allow passing a more general data flow when combining
        ...
        self.forward_storage = dict(attn=attn, query_sine_embed=query_sine_embed, key_pos=key_pos)
